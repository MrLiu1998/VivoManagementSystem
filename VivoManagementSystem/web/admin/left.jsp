...
<ul>
    <li><a href="${pageContext.request.contextPath }/adminServlet?action=getOrder&currentPage=1" target="mainFrame"><i></i>订单管理</a></li>
    <li><a href="${pageContext.request.contextPath }/adminServlet?action=getPageData&currentPage=1" target="mainFrame"><i></i>商品管理</a></li>
    <li></i><a href="account.jsp" target="mainFrame"><i></i>管理员管理</a></li>
</ul>
